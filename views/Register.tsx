  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-emerald-100 p-4">
        <div className="text-center bg-white rounded-[2rem] shadow-2xl p-12 max-w-md">
          <div className="flex items-center justify-center mb-6">
            <div className="p-6 bg-emerald-500 rounded-full">
              <CheckCircle size={48} className="text-white" />
            </div>
          </div>
          <h2 className="text-3xl font-black text-black mb-4">Conta Criada!</h2>
          <p className="text-black/60 font-medium">Redirecionando para o painel...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-black/60 font-medium">Criar Nova Conta</p>
        </div>
        ...
        <div className="bg-white rounded-[2rem] shadow-2xl p-8 border border-slate-100">
          ...
          <h2 className="text-2xl font-black text-black text-center mb-8">Cadastro</h2>
