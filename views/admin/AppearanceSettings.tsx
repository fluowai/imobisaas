        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="p-6 border-b border-gray-100 bg-gray-50 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500">Personalize cores, logo e identidade visual.</p>
                </div>
            </div>
            ...
            <div className="p-6 space-y-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">Botões, destaques, links.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                             ...
                             <p className="text-xs text-gray-400 mt-1">Bordas, detalhes sutis.</p>
                        </div>

                         <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Cor do Header</label>
                            <div className="flex gap-2">
                                <input 
                                    type="color"
                             ...
                             <p className="text-xs text-gray-400 mt-1">Fundo do menu superior.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                        <div>
                             <label className="block text-sm font-medium text-gray-700 mb-1">Upload da Logo</label>
                             <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:bg-gray-50 transition-colors relative">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="text-sm text-gray-600">
                                        <span className="font-medium text-indigo-600">Clique para enviar</span> ou arraste
                                    </div>
                            ...
                            >
                                {logoPreview ? (
                                    <img 
                                        src={logoPreview} 
                                        alt="Logo Preview" 
                                        style={{ height: `${formData.logoHeight}px`, objectFit: 'contain' }}
                                    />
                                ) : (
                             ...
                             <div className="mt-4">
                                <label className="block text-xs font-medium text-gray-500 mb-1">Altura da Logo (px)</label>
                                <input 
                                    type="range" 
                                    min="30" 
                                    max="150" 
                                ...
                                />
                                <span className="text-xs text-gray-500">{formData.logoHeight}px</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end pt-6 border-t border-gray-100">
                    <button
                        ...
                        `}
                    >
                        {saving ? 'Salvando...' : saved ? <><Check size={18} /> Salvo!</> : <><Save size={18} /> Salvar Alterações</>}
                    </button>
                </div>
            </div>
        </div>
