...
import { Save, Brain, Check, Info, Activity, Globe, Palette } from 'lucide-react';
...
const SystemSettings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'appearance' | 'ai' | 'tracking' | 'domains'>('appearance');
    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500">Gerencie a aparência e integrações do seu site</p>
        </div>
      </div>
